...
public final class _LTChatSessionOld: Logging,  ObservableObject {
    ...
    @PublishedAsyncBinding public var document: LTChatDocument
    
    public let store: LTDocumentStore
    
    public init(store: LTDocumentStore, document: PublishedAsyncBinding<LTChatDocument>) {
        self.store = store
    ...
    public func send(
        ...
        id: LTChatDocument.Message.ID? = nil
    ) {
        let message = LTChatDocument.Message(.user(messageBody))
    ...
    @MainActor
    public func delete(_ id: LTChatDocument.Message.ID) {
    ...
    @MainActor
    public func resend(_ id: LTChatDocument.Message.ID) {
        guard let message = self.document.messages[id: id] else {
            assertionFailure()
    ...
    func createPrompt(
        for message: LTChatDocument.Message,
        query: String
   ...
   @MainActor
    private func relevantMatches(
        ...
        let items: [LTDocumentFragmentIdentifier] = try store.textEmbeddings
            .query(
